...
**✅ FORMATO TAO DIRECTOR V2 VALIDADO (QA iterativo Giza, 2026-07-08):** producción migrada al workflow "TAO LTX Director V2" (el VideoFlow v3 quedó roto por el update del pack — ver memory/comfydeploy-mvc-vrgdg.md). Reglas: (1) el multi-shot va en **UNA sola línea de storyboard en prosa** (partirlo en 2 líneas genera rotación/duplicados); (2) **duración del segmento = audio + 0.3s exactos** — con aire extra el lipsync muere; el 1s de respiro del dron se resuelve en el ensamblaje recortando los gaps del master; (3) mp3 en pista DIALOGUE con Start/Duration explícitos; (4) transición = **lenta sobre el hombro** (`the camera slowly drifts past her shoulder in one smooth continuous move`), nada de whip pan brusco ni drone/órbita; (5) 720×1280, FPS 30/25, guide strength 1.00; (6) el V2 no expone nodo de negativos en el timeline — buscarlo en el grafo/config global, y si no está, la prosa estructurada basta. Duraciones V2: hook 5.8 · Giza 4.2 · Muralla 5.0 · Petra 5.0 · Coliseo 4.5 · Taj 4.3 · Machu 5.4 · Chichén 4.9 · CTA 5.9.
...
```
UGC-style selfie photo, vertical 9:16, waist-up, one extended arm holding the camera. Use the attached character sheet for exact facial identity: young woman mid-twenties, short sleek black bob, hazel green eyes, pale warm olive skin, curvy hourglass figure, gold "N" initial necklace. Wearing a fitted black athletic top with a light utility jacket tied at her waist and a small crossbody bag. Her head straight and level, facing the camera directly, frontal symmetrical framing, direct eye contact into the lens, no head tilt. Standing at [LOCACIÓN + detalle: "the Giza plateau, the three pyramids clearly visible behind her in warm morning light"]. Golden hour / bright daylight, natural skin texture with visible pores, authentic travel vlog feel, 24mm selfie look. Tourists blurred in the far background. No text, no plastic skin, no tilted head, no three-quarter profile.
```
