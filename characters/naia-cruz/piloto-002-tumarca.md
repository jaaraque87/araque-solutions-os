...
**SEG 4 — IMG-A-CROP (recorte cerrado de IMG-A: cara y hombros, LATA FUERA DE CUADRO, 9:16) + `seg4-cta-avatar.mp3` (3.78s) → ⏱ DURACIÓN CLIP: 4.1s · CFG 1.2 · 30fps:**

> QA: la versión con lata en mano falló 2 veces (lata flotando / letras deformes / lipsync muerto). El CTA va SIN producto en cuadro: la lata ya se vendió en SEG 1-3.
