...
1. **"Paul" = el dueño (Jhon / Araque Solutions).** Todos los gates (GATE 1-4) validan con él. La regla de oro se mantiene: pipeline GATED, nunca corre de punta a punta sola, y cada generación en fal/OpenAI GASTA — pedir autorización explícita antes de cada paso que consuma créditos.
   **REGLA REFORZADA (orden del dueño 2026-07-12): antes de ejecutar CUALQUIER generación en Seedance, mostrarle VISUALMENTE los assets (storyboard, imágenes de referencia, guion de la escena sonora, prompt final) y esperar su aprobación EXPLÍCITA de cada uno. Nada se genera sin su OK previo, sin excepciones.**
